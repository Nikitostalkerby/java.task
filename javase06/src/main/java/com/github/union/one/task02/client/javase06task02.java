...
import com.github.union.one.task02.core.Gender;
import com.github.union.one.task02.core.PetShop;
import com.github.union.one.task02.io.Writer;
import com.github.union.one.task02.io.Reader;
...
public class javase06task02 {
    public static void main(String[] args) throws IOException, ClassNotFoundException, CloneNotSupportedException {
        final String path = "javase06task02.txt";
